  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 mx-auto">
        <h2>Creacion de Foro</h2>
          <div class="container">
            <div class="jumbotron">
                <table class="table">
              <thead class="thead-light">
                  <tr>
                    <th scope="col">Nombre Discusion</th>
                    <th scope="col"><input id="TextForo1" type="text" /></th>
                ...
                <tr>
                  ...
                  <td><p>Descripcion del foro</td>
                  <td><textarea></textarea></td>
                </tr>

                <tr>
                  <td><p>Tema del foro</td>
                  <td><input id="TextForo3" type="text" /></td>
                </tr>
